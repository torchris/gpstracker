...
#      button_press = button_checking(input)
      ...
      button_press_str = str(button_press)    
      ...
      with canvas(device) as draw:
       ...
       draw.text((5, 40), "Btn: ", font=font, fill=255)       
       draw.text((35,40), button_press_str, font=font, fill=255) 
